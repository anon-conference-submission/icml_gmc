...
from gmc_code.unsupervised.architectures.baselines.mvae import MhdMVAE
from gmc_code.unsupervised.architectures.baselines.mmvae import MhdMMVAE
from gmc_code.unsupervised.architectures.baselines.mfm import MhdMFM
from gmc_code.unsupervised.architectures.baselines.muse import MhdMUSE
from gmc_code.unsupervised.architectures.baselines.nexus import MhdMexus
...
def setup_model(scenario, model, model_config, scenario_config, data_module=None):
    if model == "gmc":
        ...
        if scenario == "mhd":
            ...
            raise ValueError(
                "[Model Setup] Selected scenario not yet implemented for MVAE model: "
                + str(scenario)
            )
        ...
        if scenario == "mhd":
            ...
            raise ValueError(
                "[Model Setup] Selected scenario not yet implemented for MFM model: "
                + str(scenario)
            )
        ...
        if scenario == "mhd":
            ...
            raise ValueError(
                "[Model Setup] Selected scenario not yet implemented for MMVAE model: "
                + str(scenario)
            )
        ...
        if scenario == "mhd":
            ...
            raise ValueError(
                "[Model Setup] Selected scenario not yet implemented for MUSE model: "
                + str(scenario)
            )
        ...
        if scenario == "mhd":
            ...
            raise ValueError(
                "[Model Setup] Selected scenario not yet implemented for Nexus model: "
                + str(scenario)
            )
