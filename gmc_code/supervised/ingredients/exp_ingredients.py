...
def exp_config():
    ...
    if scenario == "mosi":
        ...
        elif model == "multimodal_transformer":
            model_config = sacred_model.multimodal_transformer_mosi()
            model_train_config = sacred_model.multimodal_transformer_mosi_train()

        else:
            raise ValueError("[Exp Ingredient] Model not yet implemented for MOSI environment : " + model)
        ...
        if model == "gmc":
            ...
            model_config = sacred_model.multimodal_transformer_mosei()
            model_train_config = sacred_model.multimodal_transformer_mosei_train()

        else:
            raise ValueError("[Exp Ingredient] Model not yet implemented for MOSEI environment : " + model)
